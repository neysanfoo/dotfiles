return function()
  ...
  local git_diff_files = function()
    require("config.git_diff").open({ group_files = true })
  end
  keymap("n", "<leader>gF", git_diff_files, { desc = "Find changed Git files" })
  vim.api.nvim_create_user_command("GitDiffFiles", git_diff_files, { desc = "Find changed Git files" })
